...
class PublicUserApiTest(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@examle.com', 'password': 'password'}
        create_user(**payload)
    ...
    def test_create_token_no_user(self):
        """Test that token in not created is user doesn't exist"""
        payload = {'email': 'test@example.com', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 't@e.com', 'password': ''})
...
class PrivateUserApiTest(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test that POST not allows on the me url"""
